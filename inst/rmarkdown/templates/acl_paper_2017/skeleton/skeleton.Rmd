...
[-@Gusfield97], but otherwise place the entire reference in
parentheses with the authors and year separated by a comma
[@Gusfield97]. List multiple references alphabetically and
separate them by semicolons [@Chandra81; @Gusfield97]. 
