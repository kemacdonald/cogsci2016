...
All the default content below is lifted directly from {[}Kyle
MacDonald's Cogsci 2016{]}
project(\url{https://github.com/kemacdonald/cogsci2016}), which this
entire package is based on. I haven't changed it, so it's up to you to
ignore as you please.
...
\begin{tabular}{rrrrr}
 ...
 & Estimate & Std. Error & t value & Pr($>$$|$t$|$) \\ 
  \hline
(Intercept) & -0.02 & 0.09 & -0.2 & 0.86 \\ 
  x & 1.97 & 0.10 & 20.5 & 0.00 \\ 
   \hline
\end{tabular}
...
the end of the paper. \cite{APA:83}
